...
class MainHandler(BaseHandler):
    def get(self):
        ...
        self.response.write(template.render(name = "Dashboard", user = UserInformation.query(), token = self.session.get("access_token")))
...
class Project(BaseHandler):
    def get(self):
        ...
        self.response.write(template.render(name = "Project Overview", project = auth_contents))
